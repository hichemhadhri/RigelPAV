...
public class SkyCanvasPainter {
	...
	public void drawStars(ObservedSky obs, StereographicProjection projection, Transform transform ) {
		...
		for(int i =0 ; i<centers.length/2;++i) {
			...
			ctx.fillOval(getCorrCoord(centers[2*i],diameter), getCorrCoord(centers[2*i+1],diameter), diameter, diameter);
		}
	}
	...
	public void drawSun(ObservedSky obs, Transform transform ) {
		...
		ctx.fillOval(getCorrCoord(center.getX(),diameter+2),getCorrCoord(center.getY(),diameter+2),diameter+2,diameter+2);
